  ...
  return (
    <>
      <form className="auth-form" onSubmit={(event) => submit(event, false)}>
        ...
        <input id="sign-in-password" name="password" type="password" autoComplete="current-password" minLength={12} required />
      ...
      <details className="auth-sign-up">
        ...
        <form className="auth-form" onSubmit={(event) => submit(event, true)}>
          ...
          <input id="sign-up-password" name="password" type="password" autoComplete="new-password" minLength={12} required />
